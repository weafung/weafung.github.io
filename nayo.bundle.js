!(function(e) {
    ...
    function i() {
        var e = $(".mask");
        if (0 === e.length) {
            var t = document.createElement("div"); (t.className = "mask"),
...
function(e, t, n) {
    ...
    console.log("Hexo Theme Breeze.Thanks to Lemonreds & Caicai.");
...
function(e, t, n) {
    ...
    e.exports = {
        init: function() {
            function e() {
                for (var e = 1; e < a.length; e++) if (a[e] < o + i) for (var n = 0; n <= e; n++) t.eq(n).addClass(r);
            }
            ...
            t.eq(0).addClass(r),
            e(),
            $(window).scroll(function() { (i = $(window).height()),
                (o = $(window).scrollTop()),
                e();
            });
        }
...
function(e, t, n) {
    ...
    var o = function() {
        ...
        e.removeClass("icon-menu").addClass("icon-no-menu"),
    ...
    a = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : $(".mobile-toggle"),
        t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : $(".mask");
        e.removeClass("icon-no-menu").addClass("icon-menu"),
                ...
                function() {
                    ...
                    if (((o.innerHTML = ""), !(this.value.trim().length <= 0))) {
                        if ((r.forEach(function(n) {
                            var r = !0; (n.title && "" !== n.title.trim()) || (n.title = "Untitled");
                            ...
                            u = -1,
                            l = -1;
                            if (("" !== o ? t.forEach(function(e, t) { (s = i.indexOf(e)),
                                (u = o.indexOf(e)),
                                s < 0 && u < 0 ? (r = !1) : (u < 0 && (u = 0), 0 == t && (l = u));
                            }) : (r = !1), r)) { (e += "<div class='search-item'>"),
                                (e += "<a href='" + a + "' class='search-title'>" + i + "</a>");
...
function(e, t, n) {
    ...
    function o() {
        ...
        e.click(function() { (n = u.
        default.createMask()),
            t.is(":visible") ? t.hide() : (t.show(), n.show(), l($(".icon-donate-wechat")));
        ...
        var l = function(e) {
            ...
            e.addClass("donate-active"),
            t.indexOf("wechat") > 0 ? ($(".donate-img").hide(), $("#donate-qr-wechat").show()) : t.indexOf("alipay") > 0 && ($(".donate-img").hide(), $("#donate-qr-alipay").show());
        };
    }
    function a() {
        var e = $(".share-btn"),
...
function(e, t, n) {
    ...
    function i() {
        ...
        if (e.length > 0) {
            var t = e.offset().top,
            n = $(window).scrollTop();
            t < n && e.addClass("toc-fixed"),
            (n < 90 || u()) && e.removeClass("toc-fixed");
        }
    }
    function o() {
...
function(e, t, n) {
    ...
    function i(e) { ("" !== e && void 0 !== e) || (e = document.getElementsByTagName("img")),
        (this.config = {
            width: 0.66 * window.innerWidth,
    ...
    (i.prototype = {
        init: function() {
            var e = this;
            if (s.
        default.isPc) for (var t = 0; t < this.elements.length; t++) ! (function(t) {
                e.elements[t].addEventListener("click",
                function() {
                    e.show(e.elements[t]);
                });
            })(t);
        ...
        show: function(e) {
            ...
            if (! (e.height < 340 || e.width < 340 || e.height > r || e.width > n)) {
                ...
                s = document.createElement("img"); (o.className = i.container),
                (a.className = i.box),
                (s.className = i.img);
        ...
        setStyle: function(e, t, n, r) {
            e.forEach(function(e) {
                var r = e.style; (r.width = t + "px"),
                (r.height = n + "px"),
                (r.marginTop = -0.5 * n + "px"),
                (r.marginLeft = -0.5 * t + "px");
            });
        },
...
function(e, t, n) {
    ...
    t.init = function() {
        var e = document.getElementsByClassName("lazyload"); (HTMLCollection.prototype.forEach = function(e) {
...
function(e, t, n) {
    "use strict"; (function(e) {
        ...
        function(a, s) {
            ...
            function d(e, t, n) {
                return ke(t) ? Ne.grep(e,
                function(e, r) {
                    return !! t.call(e, r, e) !== n;
                }) : t.nodeType ? Ne.grep(e,
                function(e) {
                    return (e === t) !== n;
                }) : "string" != typeof t ? Ne.grep(e,
                function(e) {
            ...
            function y() {
                de.removeEventListener("DOMContentLoaded", y),
                a.removeEventListener("load", y),
                Ne.ready();
            }
            function x(e, t) {
            ...
            function k(e, t, n, r) {
                ...
                if (c && c[3] !== l) {
                    for (u /= 2, l = l || c[3], c = +u || 1; a--;) Ne.style(e, t, c + l),
            ...
            function D(e, t, n, r, i) {
                for (var o, a, s, u, c, f, d = t.createDocumentFragment(), p = [], h = 0, g = e.length; h < g; h++) if ((o = e[h]) || 0 === o) if ("object" === l(o)) Ne.merge(p, o.nodeType ? [o] : o);
                else if (ot.test(o)) {
                    for (a = a || d.appendChild(t.createElement("div")), s = (nt.exec(o) || ["", ""])[1].toLowerCase(), u = it[s] || it._default, a.innerHTML = u[1] + Ne.htmlPrefilter(o) + u[2], f = u[0]; f--;

                    ) a = a.lastChild;
                    Ne.merge(p, a.childNodes),
                    ((a = d.firstChild).textContent = "");
                } else p.push(t.createTextNode(o));
                for (d.textContent = "", h = 0; (o = p[h++]);) if (r && Ne.inArray(o, r) > -1) i && i.push(o);
                else if (((c = Ne.contains(o.ownerDocument, o)), (a = N(d.appendChild(o), "script")), c && A(a), n)) for (f = 0; (o = a[f++]);) rt.test(o.type || "") && n.push(o);
                return d;
            }
            function j() {
                return ! 0;
            ...
            function M(e, t) {
                ...
                if (1 === t.nodeType) {
                    if (Ue.hasData(e) && ((o = Ue.access(e)), (a = Ue.set(t, o)), (l = o.events))) {
                        delete a.handle,
                        (a.events = {});
                        for (i in l) for (n = 0, r = l[i].length; n < r; n++) Ne.event.add(t, i, l[i][n]);
                    }
                    Xe.hasData(e) && ((s = Xe.access(e)), (u = Ne.extend({},
                    s)), Xe.set(t, u));
                }
            }
            function I(e, t) {
            ...
            function R(e, t, n, r) {
                ...
                if (d && ((i = D(t, e[0].ownerDocument, !1, e, r)), (o = i.firstChild), 1 === i.childNodes.length && (i = o), o || r)) {
                    for (s = (a = Ne.map(N(i, "script"), H)).length; f < d; f++)(l = i),
                    f !== p && ((l = Ne.clone(l, !0, !0)), s && Ne.merge(a, N(l, "script"))),
                    n.call(e[f], l, f);
                    if (s) for (c = a[a.length - 1].ownerDocument, Ne.map(a, P), f = 0; f < s; f++)(l = a[f]),
                    rt.test(l.type || "") && !Ue.access(l, "globalEval") && Ne.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? Ne._evalUrl && Ne._evalUrl(l.src) : u(l.textContent.replace(pt, ""), c, l));
                }
                return e;
            }
            function B(e, t, n) {
                for (var r, i = t ? Ne.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || Ne.cleanData(N(r)),
                r.parentNode && (n && Ne.contains(r.ownerDocument, r) && A(N(r, "script")), r.parentNode.removeChild(r));
                return e;
            }
            function W(e, t, n) {
            ...
            function z(e) {
                var t = Ne.cssProps[e];
                return t || (t = Ne.cssProps[e] = _(e) || e),
                t;
            }
            function U(e, t, n) {
                var r = Qe.exec(t);
            ...
            function X(e, t, n, r, i, o) {
                ...
                for (; a < 4; a += 2)"margin" === n && (u += Ne.css(e, n + Je[a], !0, i)),
                r ? ("content" === n && (u -= Ne.css(e, "padding" + Je[a], !0, i)), "margin" !== n && (u -= Ne.css(e, "border" + Je[a] + "Width", !0, i))) : ((u += Ne.css(e, "padding" + Je[a], !0, i)), "padding" !== n ? (u += Ne.css(e, "border" + Je[a] + "Width", !0, i)) : (s += Ne.css(e, "border" + Je[a] + "Width", !0, i)));
            ...
            function Z(e, t, n) {
                ...
                n.queue || (null == (a = Ne._queueHooks(e, "fx")).unqueued && ((a.unqueued = 0), (s = a.empty.fire), (a.empty.fire = function() {
                    ...
                    d.always(function() {
                        a.unqueued--,
                        Ne.queue(e, "fx").length || a.empty.fire();
                    });
                }));
                ...
                if ((u = !Ne.isEmptyObject(t)) || !Ne.isEmptyObject(p)) {
                    ...
                    n.overflow && ((h.overflow = "hidden"), d.always(function() { (h.overflow = n.overflow[0]),
            ...
            function ee(e, t) {
                var n, r, i, o, a;
                for (n in e) if (((r = b(n)), (i = t[r]), (o = e[n]), Array.isArray(o) && ((i = o[1]), (o = e[n] = o[0])), n !== r && ((e[r] = o), delete e[n]), (a = Ne.cssHooks[r]) && "expand" in a)) { (o = a.expand(o)),
                    delete e[r];
            ...
            function te(e, t, n) {
                ...
                c = l.props;
                for (ee(c, l.opts.specialEasing); o < a; o++) if ((r = te.prefilters[o].call(l, e, c, l.opts))) return (ke(r.stop) && (Ne._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r);
            ...
            function ae(e) {
                return function(t, n) {
                    ...
                    if (ke(n)) for (; (r = o[i++]);)"+" === r[0] ? ((r = r.slice(1) || "*"), (e[r] = e[r] || []).unshift(n)) : (e[r] = e[r] || []).push(n);
                };
            }
            function se(e, t, n, r) {
                function i(s) {
                    var u;
                    return ((o[s] = !0), Ne.each(e[s] || [],
                    function(e, s) {
                        var l = s(t, n, r);
            ...
            Ae = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g; (Ne.fn = Ne.prototype = {
                jquery: "3.3.1",
                constructor: Ne,
                length: 0,
                toArray: function() {
            ...
            (Ne.extend = Ne.fn.extend = function() {
                ...
                l = arguments.length,
                c = !1;
                for ("boolean" == typeof s && ((c = s), (s = arguments[u] || {}), u++), "object" == (void 0 === s ? "undefined": o(s)) || ke(s) || (s = {}), u === l && ((s = this), u--); u < l; u++) if (null != (e = arguments[u])) for (t in e)(n = s[t]),
                s !== (r = e[t]) && (c && r && (Ne.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? ((i = !1), (a = n && Array.isArray(n) ? n: [])) : (a = n && Ne.isPlainObject(n) ? n: {}), (s[t] = Ne.extend(c, a, r))) : void 0 !== r && (s[t] = r));
                return s;
            }),
            Ne.extend({
            ...
            "function" == typeof Symbol && (Ne.fn[Symbol.iterator] = fe[Symbol.iterator]),
            Ne.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),
            function(e, t) {
            ...
            var De = (function(e) {
                    ...
                    if (!r && ((t ? t.ownerDocument || t: R) !== $ && j(t), (t = t || $), q)) {
                        if (11 !== h && (u = ge.exec(e))) if ((i = u[1])) {
                            if (9 === h) {
                                ...
                                n;
                            } else if (p && (a = p.getElementById(i)) && M(t, a) && a.id === i) return n.push(a),
                            n;
                        } else {
                        ...
                        if (b.qsa && !z[e + " "] && (!O || !O.test(e))) {
                            ...
                            (d = e);
                                ...
                                for ((s = t.getAttribute("id")) ? (s = s.replace(xe, be)) : t.setAttribute("id", (s = I)), o = (c = k(e)).length; o--;

                                ) c[o] = "#" + s + " " + f(c[o]); (d = c.join(",")),
                ...
                function d(e, t, n) {
                    ...
                    function(t, n, i) {
                        ...
                        } else for (; (t = t[r]);) if (1 === t.nodeType || a) if (((f = t[I] || (t[I] = {})), (c = f[t.uniqueID] || (f[t.uniqueID] = {})), i && i === t.nodeName.toLowerCase())) t = t[r] || t;
                        else {
                ...
                function v(e, t, n, i, o, a) {
                    return (i && !i[I] && (i = v(i)), o && !o[I] && (o = v(o, a)), r(function(r, a, s, u) {
                        ...
                        x = n ? o || (r ? e: v || i) ? [] : a: y;
                        if ((n && n(y, x, s, u), i)) for (l = g(x, p), i(l, [], s, u), c = l.length; c--;
                ...
                function m(e) {
                    ...
                    o = w.relative[e[0].type], a = o || w.relative[" "], s = o ? 1 : 0, u = d(function(e) {
                        return e === t;
                    },
                    a, !0), l = d(function(e) {
                        return K(t, e) > -1;
                    ...
                    a, !0), c = [function(e, n, r) {
                        ...
                        return (t = null),
                        i;
                    }]; s < i; s++) if ((n = w.relative[e[s].type])) c = [d(p(c), n)];
                    else {
                ...
                function y(e, n) {
                    ...
                    a = function(r, a, s, u, l) {
                        ...
                        if (((p += h), i && h !== p)) {
                            ...
                            if (r) {
                                if (p > 0) for (; h--;) v[h] || m[h] || (m[h] = G.call(u));
                                m = g(m);
                            }
                            Q.apply(u, m),
                ...
                (j = t.setDocument = function(e) {
                    ...
                    function(e, t) {
                    ...
                    }), (H = []), (O = []), (b.qsa = he.test($.querySelectorAll)) && (i(function(e) { (L.appendChild(e).innerHTML = "<a id='" + I + "'></a><select id='" + I + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                        ...
                        O.push(",.*:");
                    })), (b.matchesSelector = he.test((P = L.matches || L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector))) && i(function(e) { (b.disconnectedMatch = P.call(e, "*")),
                        P.call(e, "[s!='']:x"),
                        H.push("!=", re);
                    }), (O = O.length && new RegExp(O.join("|"))), (H = H.length && new RegExp(H.join("|"))), (t = he.test(L.compareDocumentPosition)), (M = t || he.test(L.contains) ?
                    function(e, t) {
                ...
                (t.attr = function(e, t) { (e.ownerDocument || e) !== $ && j(e);
                        ...
                        CHILD: function(e, t, n, r, i) {
                            ...
                            function(e) {
                                ...
                                if (v) {
                                    ...
                                    } else if ((y && (x = p = (l = (c = (f = (d = t)[I] || (d[I] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === B && l[1]), !1 === x)) for (; (d = (++p && d && d[g]) || (x = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== m: 1 !== d.nodeType) || !++x || (y && ((c = (f = d[I] || (d[I] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [B, x]), d !== t));
                ...
                return ((c.prototype = w.filters = w.pseudos), (w.setFilters = new c()), (k = t.tokenize = function(e, n) {
                    ...
                    for (s = e, u = [], l = w.preFilter; s;) { (r && !(i = ae.exec(s))) || (i && (s = s.slice(i[0].length) || s), u.push((o = []))),
                        (r = !1),
                    ...
                    o = z[e + " "];
                    if (!o) {
                        for (t || (t = k(e)), n = t.length; n--;)(o = m(t[n]))[I] ? r.push(o) : i.push(o); (o = z(e, y(i, r))).selector = e;
                    }
                    return o;
            ...
            (Ne.expr = De.selectors),
            (Ne.expr[":"] = Ne.expr.pseudos),
            (Ne.uniqueSort = Ne.unique = De.uniqueSort),
            (Ne.text = De.getText),
            (Ne.isXMLDoc = De.isXML),
            (Ne.contains = De.contains),
            (Ne.escapeSelector = De.escape);
            ...
            qe = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i; (Ne.filter = function(e, t, n) {
                var r = t[0];
                return (n && (e = ":not(" + e + ")"), 1 === t.length && 1 === r.nodeType ? Ne.find.matchesSelector(r, e) ? [r] : [] : Ne.find.matches(e, Ne.grep(t,
                function(e) {
                    return 1 === e.nodeType;
                })));
            }),
            ...
            var Oe, He = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/; ((Ne.fn.init = function(e, t, n) {
                var r, i;
                if (!e) return this;
                if (((n = n || Oe), "string" == typeof e)) {
                    ...
                    if (r[1]) {
                        if (((t = t instanceof Ne ? t[0] : t), Ne.merge(this, Ne.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t: de, !0)), qe.test(r[1]) && Ne.isPlainObject(t))) for (r in t) ke(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                        return this;
                    }
            ...
            Ne.fn.extend({
                ...
                closest: function(e, t) {
                    ...
                    if (!Le.test(e)) for (; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && Ne.find.matchesSelector(n, e))) {
                        o.push(n);
                        break;
                    }
            ...
            var Ie = /[^\x20\t\r\n\f]+/g; (Ne.Callbacks = function(e) {
                e = "string" == typeof e ? h(e) : Ne.extend({},
                e);
                var t, n, r, i, o = [],
                a = [],
                s = -1,
                ...
                c = {
                    ...
                    remove: function() {
                        return (Ne.each(arguments,
                        function(e, t) {
                            for (var n; (n = Ne.inArray(t, o, n)) > -1;
            ...
            Ne.extend({
                Deferred: function(e) {
                    var t = [["notify", "progress", Ne.Callbacks("memory"), Ne.Callbacks("memory"), 2], ["resolve", "done", Ne.Callbacks("once memory"), Ne.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", Ne.Callbacks("once memory"), Ne.Callbacks("once memory"), 1, "rejected"]],
                    n = "pending",
                    r = {
                        state: function() {
                            return n;
                        ...
                        then: function(e, n, r) {
                            function i(e, t, n, r) {
                                return function() {
                                    ...
                                    c = function() {
                                        var a, c;
                                        if (! (e < s)) {
                                            if ((a = n.apply(u, l)) === t.promise()) throw new TypeError("Thenable self-resolution"); (c = a && ("object" == (void 0 === a ? "undefined": o(a)) || "function" == typeof a) && a.then),
                                            ke(c) ? r ? c.call(a, i(s, t, g, r), i(s, t, v, r)) : (s++, c.call(a, i(s, t, g, r), i(s, t, v, r), i(s, t, g, t.notifyWith))) : (n !== g && ((u = void 0), (l = [a])), (r || t.resolveWith)(u, l));
                                        }
                                    },
                                    f = r ? c: function() {
                                        try {
                                            ...
                                            Ne.Deferred.exceptionHook && Ne.Deferred.exceptionHook(r, f.stackTrace),
                                            e + 1 >= s && (n !== v && ((u = void 0), (l = [r])), t.rejectWith(u, l));
                                        }
                                    };
                            ...
                            return Ne.Deferred(function(o) {
                                t[0][3].add(i(0, o, ke(r) ? r: g, o.notifyWith)),
                                t[1][3].add(i(0, o, ke(e) ? e: g)),
                                t[2][3].add(i(0, o, ke(n) ? n: v));
                            }).promise();
                        },
                        promise: function(e) {
            ...
            var Re = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/; (Ne.Deferred.exceptionHook = function(e, t) {
            ...
            var Be = Ne.Deferred(); (Ne.fn.ready = function(e) {
                return (Be.then(e).
                catch(function(e) {
                    Ne.readyException(e);
                }), this);
            ...
            Ne.extend({
                isReady: !1,
                readyWait: 1,
                ready: function(e) { (!0 === e ? --Ne.readyWait: Ne.isReady) || ((Ne.isReady = !0), (!0 !== e && --Ne.readyWait > 0) || Be.resolveWith(de, [Ne]));
                }
            }),
            (Ne.ready.then = Be.then),
            "complete" === de.readyState || ("loading" !== de.readyState && !de.documentElement.doScroll) ? a.setTimeout(Ne.ready) : (de.addEventListener("DOMContentLoaded", y), a.addEventListener("load", y));
            var We = function e(t, n, r, i, o, a, s) {
                ...
                }))), n)) for (; u < c; u++) n(t[u], r, s ? i: i.call(t[u], u, n(t[u], r)));
            ...
            Ne.fn.extend({
                ...
                promise: function(e, t) {
                    ...
                    )(n = Ue.get(o[a], e + "queueHooks")) && n.empty && (r++, n.empty.add(s));
                    return s(),
                    i.promise(t);
                }
            });
            ...
            var ot = /<|&#?\w+;/; ! (function() {
                ...
                e.appendChild(t),
                (Te.checkClone = e.cloneNode(!0).cloneNode(!0).lastChild.checked),
                (e.innerHTML = "<textarea>x</textarea>"),
                (Te.noCloneChecked = !!e.cloneNode(!0).lastChild.defaultValue);
            })();
            ...
            lt = /^([^.]*)(?:\.(.+)|)/; (Ne.event = {
                ...
                add: function(e, t, n, r, i) {
                    ...
                    if (v) for (n.handler && ((n = (o = n).handler), (i = o.selector)), i && Ne.find.matchesSelector(at, i), n.guid || (n.guid = Ne.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function(t) {
                        return void 0 !== Ne && Ne.event.triggered !== t.type ? Ne.event.dispatch.apply(e, arguments) : void 0;
                    }), l = (t = (t || "").match(Ie) || [""]).length; l--;

                    )(p = g = (s = lt.exec(t[l]) || [])[1]),
                    (h = (s[2] || "").split(".").sort()),
                    p && ((f = Ne.event.special[p] || {}), (p = (i ? f.delegateType: f.bindType) || p), (f = Ne.event.special[p] || {}), (c = Ne.extend({
                        type: p,
                        origType: g,
                        data: r,
                        handler: n,
                ...
                remove: function(e, t, n, r, i) {
                    ...
                    if (v && (u = v.events)) {
                        for (l = (t = (t || "").match(Ie) || [""]).length; l--;
                            ...
                            for (f = Ne.event.special[p] || {},
                            d = u[(p = (r ? f.delegateType: f.bindType) || p)] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length; o--;
                        ...
                        } else for (p in u) Ne.event.remove(e, p + t[l], n, r, !0);
                ...
                dispatch: function(e) {
                    ...
                    if (((s.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, s))) {
                        for (a = Ne.event.handlers.call(this, s, l), t = 0; (i = a[t++]) && !s.isPropagationStopped();

                        ) for (s.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !s.isImmediatePropagationStopped();

                        )(s.rnamespace && !s.rnamespace.test(o.namespace)) || ((s.handleObj = o), (s.data = o.data), void 0 !== (r = ((Ne.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, u)) && !1 === (s.result = r) && (s.preventDefault(), s.stopPropagation()));
                ...
                handlers: function(e, t) {
                    ...
                    if (u && l.nodeType && !("click" === e.type && e.button >= 1)) for (; l !== this; l = l.parentNode || this) if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                        for (o = [], a = {},
                        n = 0; n < u; n++) void 0 === a[(i = (r = t[n]).selector + " ")] && (a[i] = r.needsContext ? Ne(i, this).index(l) > -1 : Ne.find(i, this, null, [l]).length),
                        a[i] && o.push(r);
                        o.length && s.push({
                            elem: l,
                            handlers: o
            ...
            (Ne.Event = function(e, t) {
                ...
                e && e.type ? ((this.originalEvent = e), (this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? j: $), (this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode: e.target), (this.currentTarget = e.currentTarget), (this.relatedTarget = e.relatedTarget)) : (this.type = e),
                t && Ne.extend(this, t),
            ...
            (Ne.Event.prototype = {
                ...
                preventDefault: function() {
                    var e = this.originalEvent; (this.isDefaultPrevented = j),
                    e && !this.isSimulated && e.preventDefault();
                },
                stopPropagation: function() {
                    var e = this.originalEvent; (this.isPropagationStopped = j),
                    e && !this.isSimulated && e.stopPropagation();
                },
                stopImmediatePropagation: function() {
                    var e = this.originalEvent; (this.isImmediatePropagationStopped = j),
            ...
            Ne.extend({
                ...
                clone: function(e, t, n) {
                    ...
                    if (! (Te.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || Ne.isXMLDoc(e))) for (a = N(s), r = 0, i = (o = N(e)).length; r < i; r++) I(o[r], a[r]);
                    if (t) if (n) for (o = o || N(e), a = a || N(s), r = 0, i = o.length; r < i; r++) M(o[r], a[r]);
                    else M(e, s);
                    return ((a = N(s, "script")).length > 0 && A(a, !u && N(e, "script")), s);
                },
                cleanData: function(e) {
                    for (var t, n, r, i = Ne.event.special,
                    o = 0; void 0 !== (n = e[o]); o++) if (ze(n)) {
                        if ((t = n[Ue.expando])) {
            ...
            Ne.fn.extend({
                ...
                text: function(e) {
                    return We(this,
                    function(e) {
                        return void 0 === e ? Ne.text(this) : this.empty().each(function() { (1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType) || (this.textContent = e);
                        });
                    },
                ...
                append: function() {
                    ...
                    function(e) { (1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType) || O(this, e).appendChild(e);
                    });
                },
                prepend: function() {
                    return R(this, arguments,
            ...
            function(e, t) {
                Ne.fn[e] = function(e) {
                    for (var n, r = [], i = Ne(e), o = i.length - 1, a = 0; a <= o; a++)(n = a === o ? this: this.clone(!0)),
                    Ne(i[a])[t](n),
                    ve.apply(r, n.get());
            ...
            vt = new RegExp(Je.join("|"), "i"); ! (function() {
                function e() {
                    if (l) { (u.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0"),
                        (l.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%"),
                        at.appendChild(u).appendChild(l);
                        var e = a.getComputedStyle(l); (n = "1%" !== e.top),
                        (s = 12 === t(e.marginLeft)),
                        (l.style.right = "60%"),
                        (o = 36 === t(e.right)),
                        (r = 36 === t(e.width)),
            ...
            Ne.extend({
                ...
                style: function(e, t, n, r) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        ...
                        "string" == (a = void 0 === n ? "undefined": o(n)) && (i = Qe.exec(n)) && i[1] && ((n = k(e, t, i)), (a = "number")),
                        null != n && n === n && ("number" === a && (n += (i && i[3]) || (Ne.cssNumber[u] ? "": "px")), Te.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), (s && "set" in s && void 0 === (n = s.set(e, n, r))) || (l ? c.setProperty(t, n) : (c[t] = n)));
                    }
                },
            ...
            function(e, t) {
                Ne.cssHooks[t] = {
                    get: function(e, n, r) {
                        if (n) return ! mt.test(Ne.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width) ? V(e, t, r) : Ze(e, xt,
                        function() {
                            return V(e, t, r);
                        });
                    },
                    set: function(e, n, r) {
                        ...
                        s = r && X(e, t, r, a, o);
                        return (a && Te.scrollboxSize() === o.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - X(e, t, "border", !1, o) - 0.5)), s && (i = Qe.exec(n)) && "px" !== (i[3] || "px") && ((e.style[t] = n), (n = Ne.css(e, t))), U(e, n, s));
                    }
                };
            }),
            (Ne.cssHooks.marginLeft = F(Te.reliableMarginLeft,
            function(e, t) {
            ...
            function(e, t) { (Ne.cssHooks[e + t] = {
                    expand: function(n) {
                        for (var r = 0,
                        i = {},
                        o = "string" == typeof n ? n.split(" ") : [n]; r < 4; r++) i[e + Je[r] + t] = o[r] || o[r - 2] || o[0];
                        return i;
                    }
                }),
            ...
            (G.prototype = {
                ...
                init: function(e, t, n, r, i, o) { (this.elem = e),
                    (this.prop = n),
                    (this.easing = i || Ne.easing._default),
                    (this.options = t),
            ...
            (Ne.fx = G.prototype.init),
            (Ne.fx.step = {});
            var Tt, kt, Et = /^(?:toggle|show|hide)$/,
            St = /queueHooks$/; (Ne.Animation = Ne.extend(te, {
                tweeners: {
                    "*": [function(e, t) {
                        var n = this.createTween(e, t);
                        return k(n.elem, e, Qe.exec(t), n),
                        n;
                    }]
                },
            ...
            (Ne.speed = function(e, t, n) {
                var r = e && "object" == (void 0 === e ? "undefined": o(e)) ? Ne.extend({},
                e) : {
            ...
            Ne.fn.extend({
                ...
                finish: function(e) {
                    return (!1 !== e && (e = e || "fx"), this.each(function() {
                        ...
                        o = Ne.timers,
                        a = r ? r.length: 0;
                        for (n.finish = !0, Ne.queue(this, e, []), i && i.stop && i.stop.call(this, !0), t = o.length; t--;
            ...
            (Ne.fn.delay = function(e, t) {
                return ((e = Ne.fx ? Ne.fx.speeds[e] || e: e), (t = t || "fx"), this.queue(t,
                function(t, n) {
            ...
            (function() {
                ...
                t = de.createElement("select").appendChild(de.createElement("option")); (e.type = "checkbox"),
                (Te.checkOn = "" !== e.value),
                (Te.optSelected = t.selected),
                ((e = de.createElement("input")).value = "t"),
                (e.type = "radio"),
            ...
            Ne.each(Ne.expr.match.bool.source.match(/\w+/g),
            function(e, t) {
            ...
            Ne.each(["tabIndex", "readOnly", "maxLength", "cellSpacing", "cellPadding", "rowSpan", "colSpan", "useMap", "frameBorder", "contentEditable"],
            function() {
            ...
            Ne.fn.extend({
                addClass: function(e) {
                    ...
                    if ((t = ie(e)).length) for (; (n = this[u++]);) if (((i = re(n)), (r = 1 === n.nodeType && " " + ne(i) + " "))) {
                ...
                removeClass: function(e) {
                    ...
                    if ((t = ie(e)).length) for (; (n = this[u++]);) if (((i = re(n)), (r = 1 === n.nodeType && " " + ne(i) + " "))) {
                        for (a = 0; (o = t[a++]);) for (; r.indexOf(" " + o + " ") > -1;
                ...
                toggleClass: function(e, t) {
                    ...
                    return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : ke(e) ? this.each(function(n) {
                        ...
                        var t, i, o, a;
                        if (r) for (i = 0, o = Ne(this), a = ie(e); (t = a[i++]);
            ...
            Ne.fn.extend({
                val: function(e) {
                    ...
                    return arguments.length ? ((r = ke(e)), this.each(function(n) {
                        var i;
                        1 === this.nodeType && (null == (i = r ? e.call(this, n, Ne(this).val()) : e) ? (i = "") : "number" == typeof i ? (i += "") : Array.isArray(i) && (i = Ne.map(i,
                        function(e) {
                            return null == e ? "": e + "";
                ...
                valHooks: {
                    ...
                    select: {
                        get: function(e) {
                            ...
                            s = a ? null: [],
                            u = a ? o + 1 : i.length;
                            for (r = o < 0 ? u: a ? o: 0; r < u; r++) if (((n = i[r]).selected || r === o) && !n.disabled && (!n.parentNode.disabled || !f(n.parentNode, "optgroup"))) {
                        ...
                        set: function(e, t) {
                            ...
                            o = Ne.makeArray(t), a = i.length; a--;

                            )((r = i[a]).selected = Ne.inArray(Ne.valHooks.option.get(r), o) > -1) && (n = !0);
                ...
                trigger: function(e, t, n, r) {
                    ...
                    if (((s = p = u = n = n || de), 3 !== n.nodeType && 8 !== n.nodeType && !Lt.test(g + Ne.event.triggered) && (g.indexOf(".") > -1 && ((g = (v = g.split(".")).shift()), v.sort()), (c = g.indexOf(":") < 0 && "on" + g), (e = e[Ne.expando] ? e: new Ne.Event(g, "object" == (void 0 === e ? "undefined": o(e)) && e)), (e.isTrigger = r ? 2 : 3), (e.namespace = v.join(".")), (e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null), (e.result = void 0), e.target || (e.target = n), (t = null == t ? [e] : Ne.makeArray(t, [e])), (d = Ne.event.special[g] || {}), r || !d.trigger || !1 !== d.trigger.apply(n, t)))) {
                        if (!r && !d.noBubble && !Ee(n)) {
                            for (l = d.delegateType || g, Lt.test(l + g) || (s = s.parentNode); s; s = s.parentNode) h.push(s),
                            (u = s);
                        ...
                        (e.type = i > 1 ? l: d.bindType || g),
                        (f = (Ue.get(s, "events") || {})[e.type] && Ue.get(s, "handle")) && f.apply(s, t),
                        (f = c && s[c]) && f.apply && ze(s) && ((e.result = f.apply(s, t)), !1 === e.result && e.preventDefault());
            ...
            Bt = /^(?:input|select|textarea|keygen)/i; (Ne.param = function(e, t) {
                var n, r = [],
                i = function(e, t) {
                    var n = ke(t) ? t() : t;
                    r[r.length] = encodeURIComponent(e) + "=" + encodeURIComponent(null == n ? "": n);
                };
                if (Array.isArray(e) || (e.jquery && !Ne.isPlainObject(e))) Ne.each(e,
                function() {
            ...
            Ne.fn.extend({
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var n = Ne(this).val();
                        return null == n ? null: Array.isArray(n) ? Ne.map(n,
                        function(e) {
                            return {
                                name: t.name,
                                value: e.replace(It, "\r\n")
            ...
            Yt = {},
            Qt = "*/".concat("*"),
            Jt = de.createElement("a"); (Jt.href = Ot.href),
            Ne.extend({
                active: 0,
                lastModified: {},
                etag: {},
                ...
                ajax: function(e, t) {
                    ...
                    (t = t || {});
                    var r, i, s, u, l, c, f, d, p, h, g = Ne.ajaxSetup({},
                    t),
                    v = g.context || g,
                    ...
                    if ((y.promise(k), (g.url = ((e || g.url || Ot.href) + "").replace(Vt, Ot.protocol + "//")), (g.type = t.method || t.type || g.method || g.type), (g.dataTypes = (g.dataType || "*").toLowerCase().match(Ie) || [""]), null == g.crossDomain)) {
                        ...
                        try { (c.href = g.url),
                            (c.href = c.href),
                            (g.crossDomain = Jt.protocol + "//" + Jt.host != c.protocol + "//" + c.host);
                        } catch(e) {
                            g.crossDomain = !0;
                        }
                    }
                    if ((g.data && g.processData && "string" != typeof g.data && (g.data = Ne.param(g.data, g.traditional)), se(Gt, g, t, k), f)) return k; (d = Ne.event && g.global) && 0 == Ne.active++&&Ne.event.trigger("ajaxStart"),
                    (g.type = g.type.toUpperCase()),
                    (g.hasContent = !Xt.test(g.type)),
                    (i = g.url.replace(Ft, "")),
                    g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Wt, "+")) : ((h = g.url.slice(i.length)), g.data && (g.processData || "string" == typeof g.data) && ((i += (Pt.test(i) ? "&": "?") + g.data), delete g.data), !1 === g.cache && ((i = i.replace(_t, "$1")), (h = (Pt.test(i) ? "&": "?") + "_=" + Ht+++h)), (g.url = i + h)),
                    g.ifModified && (Ne.lastModified[i] && k.setRequestHeader("If-Modified-Since", Ne.lastModified[i]), Ne.etag[i] && k.setRequestHeader("If-None-Match", Ne.etag[i])),
                    ((g.data && g.hasContent && !1 !== g.contentType) || t.contentType) && k.setRequestHeader("Content-Type", g.contentType),
                    k.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Qt + "; q=0.01": "") : g.accepts["*"]);
            ...
            Zt = Ne.ajaxSettings.xhr(); (Te.cors = !!Zt && "withCredentials" in Zt),
            (Te.ajax = Zt = !!Zt),
            Ne.ajaxTransport(function(e) {
                var t, n;
                if (Te.cors || (Zt && !e.crossDomain)) return {
                    send: function(r, i) {
                        ...
                        for (o in r) s.setRequestHeader(o, r[o]); (t = function(e) {
                            return function() {
            ...
            function(e) {
                if (e.crossDomain) {
                    var t, n;
                    return {
                        send: function(r, i) { (t = Ne("<script>").prop({
            ...
            function(e, t, n) {
                ...
                if (s || "jsonp" === e.dataTypes[0]) return ((r = e.jsonpCallback = ke(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback), s ? (e[s] = e[s].replace(tn, "$1" + r)) : !1 !== e.jsonp && (e.url += (Pt.test(e.url) ? "&": "?") + e.jsonp + "=" + r), (e.converters["script json"] = function() {
                    ...
                    void 0 === i ? Ne(a).removeProp(r) : (a[r] = i),
            ...
            (Ne.fn.load = function(e, t, n) {
                ...
                return (u > -1 && ((r = ne(e.slice(u))), (e = e.slice(0, u))), ke(t) ? ((n = t), (t = void 0)) : t && "object" == (void 0 === t ? "undefined": o(t)) && (i = "POST"), s.length > 0 && Ne.ajax({
                    ...
                    dataType: "html",
                    data: t
                }).done(function(e) { (a = arguments),
                    s.html(r ? Ne("<div>").append(Ne.parseHTML(e)).find(r) : e);
                }).always(n &&
                function(e, t) {
                    s.each(function() {
            ...
            Ne.each(["ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend"],
            function(e, t) {
                Ne.fn[t] = function(e) {
                    return this.on(t, e);
                };
            ...
            Ne.fn.extend({
                ...
                position: function() {
                    if (this[0]) {
                        ...
                        if ("fixed" === Ne.css(r, "position")) t = r.getBoundingClientRect();
                            ...
                            for (t = this.offset(), n = r.ownerDocument, e = r.offsetParent || n.documentElement; e && (e === n.body || e === n.documentElement) && "static" === Ne.css(e, "position");
                ...
                offsetParent: function() {
                    return this.map(function() {
                        for (var e = this.offsetParent; e && "static" === Ne.css(e, "position");
            ...
            Ne.each(["top", "left"],
            function(e, t) {
                Ne.cssHooks[t] = F(Te.pixelPosition,
                function(e, n) {
            ...
            Ne.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "),
            function(e, t) {
            ...
            (Ne.isArray = Array.isArray),
            (Ne.parseJSON = JSON.parse),
            (Ne.nodeName = f),
            (Ne.isFunction = ke),
            (Ne.isWindow = Ee),
            (Ne.camelCase = b),
